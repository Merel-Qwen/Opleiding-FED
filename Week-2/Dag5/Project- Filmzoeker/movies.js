...
// Laatste films 2014 of nieuwer

// const releaseDate = movies.filter(function(date) {
//   return parseInt(date.Year) > 2013;
// });

// console.log(releaseDate);

// const avengersFilms = movies.includes(function(name) {
//   return name.Title "Avenger"
// });

// const avengersFilms = movies.map(function(name) {
//   return name.Title;
// });

// console.log(
//   avengersFilms.includes(
//     "The Avengers",
...
// // // console.log(movies.Title.includes("Batman"));

// console.log(movies);

// const titel = movies.map(function(naam) {
//   return naam.Title;
// });
